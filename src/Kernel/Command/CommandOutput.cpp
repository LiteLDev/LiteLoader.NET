...
#include <src/Header/Command/CommandOutputParameter.hpp>
#include <src/Header/Command/CommandOutputMessage.hpp>
#include <src/Header/Command/CommandPropertyBag.hpp>
