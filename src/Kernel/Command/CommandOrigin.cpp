...
#include <src/Header/Command/CommandOriginIdentity.hpp>
#include <src/Header/Command/CommandOriginData.hpp>
#include <src/Header/Command/CommandPositionFloat.hpp>
#include <src/Header/MC/CompoundTag.hpp>
#include <src/Header/Command/CommandArea.hpp>
