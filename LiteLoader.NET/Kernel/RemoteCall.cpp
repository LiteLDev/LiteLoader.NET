...
namespace LLNET::RemoteCall
{
	...
	bool RemoteCallAPI::ExportFunc(String^ nameSpace, String^ funcName, CallbackFn^ callback)
	{
		...
		return ::RemoteCall::exportFunc(marshalString(nameSpace), marshalString(funcName), pair.pCallbackFn, GlobalClass::__GetCurrentModule(Assembly::GetCallingAssembly()));
	}
