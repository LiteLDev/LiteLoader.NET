...
namespace LLNET::Form
{
	...
	bool CustomForm::SendTo(MC::Player^ player, CustomFormCallback^ callback)
	{
		...
		::Form::CustomForm::Callback _callback
			= this->callback == nullptr ?
			::Form::CustomForm::Callback() :
			static_cast<void (*)(::Player*, std::map<string, std::shared_ptr<::Form::CustomFormElement>>)>((void*)Marshal::GetFunctionPointerForDelegate(defunc));
